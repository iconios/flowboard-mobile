...
import ShowTasks from "../tasks/show.tasks";
import CreateTaskDialog from "../tasks/create.task.modal";
  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        tasksContainer: {
          backgroundColor: theme.colors.custom.muted,
          flex: 1,
        },
        fab: {
          position: "absolute",
    ...
    <View style={styles.container}>
      ...
      <View style={styles.tasksContainer}>
        ...
        <FAB
          ...
          style={styles.fab}
          label="Add New Task"
          accessibilityLabel="Floating Action Button for Adding New Task"
          animated
          color={bgColor}
          size="large"
          onPress={() => setOpenCreateTaskDialog(true)}
        />
      </View>
      {openCreateTaskDialog && (
        <CreateTaskDialog
          dialogOpen={openCreateTaskDialog}
